...
| clientToken                       | String            | 用于上下行消息配对标识                                                                                 |
| params                            | Struct            | JSON结构内为 设备上报的 设备基础信息                                                                       |
| params.imei                       | String            | 设备的 IMEI 号信息，非必填项                                                                           |
| params.mac                        | String            | 设备的 MAC 信息，非必填项                                                                             |
| params.version                    | String            | 固件版本                                                                                        |
| params.hardinfo                   | String            | 模组具体硬件型号                                                                                    |
| params.softinfo                   | String            | 模组软件版本                                                                                      |
| params.position                   | Struct            | 坐标信息                                                                                        |
| params.position.coordinateSystem  | String            | 坐标系：WGS84(地球系)，GCJ02(火星系)，BD09(百度系)<br/>参考解释：https://www.cnblogs.com/bigroc/p/16423120.html |
| params.position.longitude         | Double            | 经度坐标(度格式，十进制)<br/>参考解释：http://www.360doc.com/document/17/1228/16/12479599_365694647.shtml      |
| params.position.latitude          | Double            | 纬度坐标(度格式，十进制)                                                                                  |
| params.tags                       | Map[String]String | 设备标签信息                                                                                      |
